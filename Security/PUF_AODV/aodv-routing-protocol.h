...
private:
  ...
  std::map< Ptr<Socket>, Ipv4InterfaceAddress > m_socketSubnetBroadcastAddresses; //to map each unicast socket with an IP interface address 
...
private:
  ...
  /// @}
  bool AodvSpecificPort(Ptr<const Packet> p);
  /**
